package com.infotech.wishmaplus.Utils.StoryProgressView;

/**
 * Created by Vishnu Agarwal on 28-10-2024.
 */
...
final class PausableProgressBar extends FrameLayout {
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(android.R.color.white);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(android.R.color.white);
